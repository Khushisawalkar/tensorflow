...
void BuildOpsSubmodule(nb::module_& m) {
  ...
  ops.def("Log1p", static_cast<XlaOp (*)(XlaOp, const ResultAccuracy&)>(&Log1p),
          nb::arg("operand"), nb::arg("result_accuracy"));
  ops.def("Log1p", static_cast<XlaOp (*)(XlaOp)>(&Log1p), nb::arg("operand"));
  ...
  ops.def("Tan", static_cast<XlaOp (*)(XlaOp, const ResultAccuracy&)>(&Tan),
          nb::arg("operand"), nb::arg("result_accuracy"));
  ops.def("Tan", static_cast<XlaOp (*)(XlaOp)>(&Tan), nb::arg("operand"));
